...
export default {
  ...
  methods: {
    ...
    setGroupsName() {
      ...
      const groupsName = {};// reset group names
      ...
      Object.keys(settings).forEach(moduleName => {
        Object.keys(settings[moduleName]).forEach(fieldName => {
          ...
          //Set group name
          if (!groupsName[moduleName]) groupsName[moduleName] = {};
          groupsName[moduleName][field.groupName || 'General'] = (field.groupTitle || 'General');
        });
      });

      this.groupsName = this.$clone(groupsName);
    },
    ...
    setSettingsGroup() {
      ...
      //Response
      this.settingsGroup = this.$clone(response);
    },
    //Set form Data
    setFormData() {
