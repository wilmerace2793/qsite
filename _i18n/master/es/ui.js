export default {
  label: {
    ...
    maritime: 'Marítimo',
    marketing: 'Marketing',
    mathematics: 'Matemática | Matemáticas',
    hospitals: 'Hospitale | Hospitales',
    transfers: 'Traslado | Traslados',
    music: 'Música',
